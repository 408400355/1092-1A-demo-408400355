function changeVideo(index) {
    ...
    switch(index) {
        ...
        case 5:
            ...
            break;
        case 6 :
            player.innerHTML = `<iframe width="560" height="315" src="https://i.ytimg.com/vi/RechrtUxfQc/hqdefault.jpg"></iframe>`;
            break;
        case 7 :
            player.innerHTML = `<iframe width="560" height="315" src="https://img.youtube.com/vi/MRWX49Furew/hqdefault.jpg"></iframe>`;
            break;
        case 8 :
            player.innerHTML = `<iframe width="560" height="315" src="https://img.youtube.com/vi/METhdbL_iMw/hqdefault.jpg"></iframe>`;
            break;
        case 9 :
            player.innerHTML = `<iframe width="560" height="315" src="https://img.youtube.com/vi/ZyDbq-lEKTo/hqdefault.jpg"></iframe>`;
            break;
        case 10 :
            player.innerHTML = `<iframe width="560" height="315" src="https://img.youtube.com/vi/NlsrJbVvjaA/hqdefault.jpg"></iframe>`;
            break;
    }
}
...
function changeColor(index) {
    ...
    switch(index) {
        case 1: p.style.backgroundColor = 'blue';
            break;
        case 2 : p.style.backgroundColor = 'purple';
            break;
        case 3 : p.style.backgroundColor = 'pink';
            break;
    }
